    ...
    <div class="main-container nav-bg-color">
        <div class="inside-container nav-contain">
            <nav class="navbar navbar-expand-lg navbar-light">
                <img src="download.png" class="img-fluid" alt="" style="width:120px;height:120px;">
                ...
                <div class="carousel-item active first-slider">
                    <div class="inside-container">
                        <div class="row">
                            <div class="col-lg-12  ">
                                <div class="our-text">
                                    <h2>Anushruth's Banking System</h2>
                                    <p>Click on the Transfer amount button if you want to transfer money from any pre-existing accounts.<br> Click on the View transactions button to view the previous transactions.</p>
                                    <div class="butns">
