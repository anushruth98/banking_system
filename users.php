...
<head>
    ...
    <title>Anushruth's banking system</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-sm">
        ...
        <a class="navbar-brand">
            <img src="download.png" alt="download" style="width:150px; height:150px">
        </a>
        <p class="download-text">Anushruth's Banking System</p>
